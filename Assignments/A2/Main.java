            ...
            if (ch == 1) {
                            ...
                            outer: while (true) {
                                ...
                                switch (animalChoice) {
                                    case 1 -> {
                                        ...
                                        admin.addAnimal(animalName, animalDescription, animalCategory);
                                        System.out.println();
                                    }
                            ...
                            outer: while (true) {
                                ...
                                switch (discountChoice) {
                                    ...
                                    case 2 -> {
                                        ...
                                        admin.modifyAgeBasedDiscount(discountCode, newDiscountCode, lowerAgeLimit, upperAgeLimit, discountPercentage);
                                        System.out.println();
                                    }
                ...
                while (true) {
                    ...
                    if (visitorChoice == 1) {
                        ...
                        admin.addVisitor(name, age, phoneNumber, balance, email, password);
                        admin.setVisitorCount(admin.getVisitorCount() + 1);
                        System.out.println();
                    }
                        ...
                        Visitor visitor = admin.findVisitor(email, password);
