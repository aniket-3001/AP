...
public class Admin {
    ...
    public void addAnimal(String name, String description, String category) {
        ...
        switch (category) {
            case "mammal" -> {
                Mammal mammals = new Mammal(name, description, category);
                animals.add(mammals);
            }
            case "reptile" -> {
                Reptile reptiles = new Reptile(name, description, category);
                animals.add(reptiles);
            }
            case "amphibian" -> {
                Amphibian amphibians = new Amphibian(name, description, category);
    ...
    public void removeAgeBasedDiscount(String discountCode) {
        ArrayList<AgeBasedDiscount> discounts = zoo.getDiscounts();
        discounts.removeIf(discount -> discount.getDiscountCode().equals(discountCode));
    }

    public void modifyAgeBasedDiscount(String discountCode, int newLowerAgeLimit, int newUpperAgeLimit, int newDiscountPercentage) {
        ArrayList<AgeBasedDiscount> discounts = zoo.getDiscounts();
